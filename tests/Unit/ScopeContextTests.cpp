...
static std::wstring stripCurrentScope(
    ...
    const std::wstring& a_currentScope)
{
    ...
    if (a_name.size() > prefix.size() &&
        a_name.compare(0, prefix.size(), prefix) == 0)
    {
...
{
    EXPECT_EQ(
        stripCurrentScope(L"Actor::SaveData::Weapon", L"Actor::SaveData"),
        L"Weapon");
}
...
{
    EXPECT_EQ(
        stripCurrentScope(L"Actor::User::Weapon", L"Actor::SaveData"),
        L"Actor::User::Weapon");
}
...
{
    EXPECT_EQ(
        stripCurrentScope(L"SaveData::Weapon", L"Actor::SaveData"),
        L"SaveData::Weapon");
}
...
TEST(ScopeStrippingTest, ExactMatchNotStripped)
{
    ...
    EXPECT_EQ(
        stripCurrentScope(L"Actor::SaveData", L"Actor::SaveData"),
        L"Actor::SaveData");
}
...
{
    EXPECT_EQ(
        stripCurrentScope(L"Actor::SaveData::Weapon", L""),
        L"Actor::SaveData::Weapon");
}

TEST(ScopeStrippingTest, ConstructorName)
{
    EXPECT_EQ(
        stripCurrentScope(L"Actor::SaveData::SaveData", L"Actor::SaveData"),
        L"SaveData");
}
...
{
    EXPECT_EQ(
        stripCurrentScope(L"Actor::SaveData::Inner::Inner", L"Actor::SaveData::Inner"),
        L"Inner");
}
...
TEST(ScopeStrippingTest, SameNameDifferentScope)
{
    ...
    EXPECT_EQ(
        stripCurrentScope(L"Test::Weapon", L"Actor::SaveData"),
        L"Test::Weapon");
}
...
TEST(ScopeStrippingTest, TemplateTypeNotStripped)
{
    ...
    EXPECT_EQ(
        stripCurrentScope(L"std::vector<int>", L"Actor"),
        L"std::vector<int>");
}
