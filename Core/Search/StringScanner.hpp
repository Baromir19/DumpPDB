...
public:
    ...
    [[nodiscard]] std::vector<StringMatch> find(
        uint32_t a_minLength, uint32_t a_encodingFlags) const
    {
...
private:
    ...
    void appendUtf8(std::wstring& a_out, size_t a_pos, size_t a_len) const noexcept
    {
        ...
        case 1:
            ...
            break;
        case 2:
            cp = (static_cast<uint32_t>(m_view[a_pos] & 0x1F) << 6) | (m_view[a_pos + 1] & 0x3F);
            break;
        case 3:
